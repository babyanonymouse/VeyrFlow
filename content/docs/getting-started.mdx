...
description: Set up your VeyrFlow account and learn the basics of tracking your habits and tasks.
---

## Create your account
- Open VeyrFlow and click **Sign Up**.
...
- After logging in, VeyrFlow takes you to your dashboard.
