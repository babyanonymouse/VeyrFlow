  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button: "h-9 w-9 p-0 rounded-md font-normal text-zinc-200 transition-colors hover:bg-zinc-900 aria-selected:bg-indigo-500/20 aria-selected:text-indigo-400 aria-selected:border aria-selected:border-indigo-500/30 aria-selected:font-semibold cursor-pointer flex items-center justify-center",
        today: "text-indigo-400 border border-indigo-500/20 font-semibold",
