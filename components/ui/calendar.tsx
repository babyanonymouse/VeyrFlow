  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button: "h-9 w-9 p-0 rounded-md font-normal text-zinc-200 transition-colors hover:bg-zinc-850 hover:bg-zinc-900 aria-selected:bg-indigo-600 aria-selected:text-white aria-selected:font-semibold cursor-pointer flex items-center justify-center",
